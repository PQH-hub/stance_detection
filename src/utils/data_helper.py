...
from transformers import BertTokenizer, AutoTokenizer, AlbertTokenizer, BertTokenizer, RobertaTokenizer, BertweetTokenizer
...
def data_helper_bert(x_train_all, x_val_all, x_test_all, model_select, config):
    ...
    if model_select == 'Bertweet':
        tokenizer = AutoTokenizer.from_pretrained("C:\\Users\\20171\\Desktop\\Papers &Codes\\Distilling Calibrated "
